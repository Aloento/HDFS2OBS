...
class DefaultOBSClientFactory extends Configured implements OBSClientFactory {
     ...
     * @throws IOException on any failure to create OTC OBS client
     */
    private static ObsClient createOTCObsClient(final Configuration conf, final ObsConfiguration obsConf,
    ...
    public ObsClient createObsClient(final URI name) throws IOException {
        ...
        return createOTCObsClient(conf, obsConf, name);
    }
}
